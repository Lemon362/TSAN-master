...
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, ResNeXt_GCNet, \
    ResNeXt_TwoStepAttention
import os
...
# 调用设计好的模型
def model_DenseNet():
    model_dense = ResNeXt_TwoStepAttention.ResneXt_IN((1, img_rows, img_cols, img_channels), classes=16)
    ...
    model_dense.compile(loss=mycrossentropy, optimizer=RMS,
                        metrics=['accuracy'])  # categorical_crossentropy

    model_dense.summary()
    plot_model(model_dense, show_shapes=True, to_file='./model_ResNeXt_TwoStepAttention_group10.png')
...
TOTAL_SIZE = 10249  # 10249 42776
VAL_SIZE = 1025  # 1025 4281
# TODO 可变参数2
...
VALIDATION_SPLIT = 0.5  # Val+Test=0.9 0.8 0.7 0.6 0.5
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = './models/Indian_best_ResNeXt_TwoStepAttention_5_1_4_60_group10_' + str(
        index_iter + 1) + '.hdf5'
    ...
    with open('./Loss_Acc/IN_ResNeXt_TwoStepAttention_5_1_4_60_group6_1.hdf5', 'w') as f:
...
modelStatsRecord.outputStats(KAPPA_3D_DenseNet, OA_3D_DenseNet, AA_3D_DenseNet, ELEMENT_ACC_3D_DenseNet,
                             ...
                             './records/IN_train_ResNeXt_TwoStepAttention_5_1_4_60_group10_1.txt',
                             './records/IN_train_element_ResNeXt_TwoStepAttention_5_1_4_60_group10_1.txt')
