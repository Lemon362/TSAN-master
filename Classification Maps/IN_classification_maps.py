...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = 'D:/3D-TwoStep-Network/models/Indian_best_ResNeXt_TwoStepAttention_5_1_4_60_' + str(
        index_iter + 1) + '.hdf5'
    ...
    classification_map(y_re, gt_IN, 24, "D:/3D-TwoStep-Network/CMaps/IN_best_ResNeXt_TwoStepAttention_5_1_4_60_1.png")
