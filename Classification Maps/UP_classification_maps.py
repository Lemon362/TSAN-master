...
def model_DenseNet():
    ...
    model_dense = ResNeXt_TwoStepAttention.ResneXt_IN((1, img_rows, img_cols, img_channels), cardinality=8, classes=9)
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = 'D:/3D-TwoStep-Network/models/UP_best_ResNeXt_TwoStepAttention_4_1_5_60_' \
    ...
    classification_map(y_re, gt_IN, 24, "D:/3D-TwoStep-Network/CMaps/UP_best_ResNeXt_TwoStepAttention_4_1_5_60_1.png")
