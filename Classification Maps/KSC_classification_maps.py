...
def model_DenseNet():
    ...
    model_dense = ResNeXt_TwoStepAttention.ResneXt_IN((1, img_rows, img_cols, img_channels), cardinality=8, classes=13)
...
mat_data = sio.loadmat('D:/3D-TwoStep-Network/Datasets/KSC/KSC.mat')
data_IN = mat_data['KSC']
mat_gt = sio.loadmat('D:/3D-TwoStep-Network/Datasets/KSC/KSC_gt.mat')
gt_IN = mat_gt['KSC_gt']
print(data_IN.shape)
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = 'D:/3D-TwoStep-Network/models/KSC_best_ResNeXt_TwoStepAttention_4_1_5_60_' \
                                 + str(index_iter + 1) + '.hdf5'
    # best_weights_DenseNet_path = 'D:/PyramidNet/3D-ResneXt-for-HSI/records/IN_ResneXt_5_1_4_50_2/Indian_best_3D_ResneXt_5_1_4_50_2.hdf5'
    ...
    classification_map(y_re, gt_IN, 24, "D:/3D-TwoStep-Network/CMaps/KSC_best_ResNeXt_TwoStepAttention_4_1_5_60_1.png")
