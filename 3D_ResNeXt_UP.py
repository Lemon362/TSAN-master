...
# 调用设计好的模型
def model_DenseNet():
    model_dense = ResNeXt_TwoStepAttention.ResneXt_IN((1, img_rows, img_cols, img_channels), classes=9)
    ...
    model_dense.summary()
    plot_model(model_dense, show_shapes=True, to_file='./model_ResNeXt_TwoStepAttention_UP_group10.png')
...
VALIDATION_SPLIT = 0.6  # Val+Test=0.9 0.8 0.7 0.6 0.5
...
for index_iter in range(ITER):
    ...
    best_weights_DenseNet_path = './models/UP_best_ResNeXt_TwoStepAttention_4_1_5_60_group10_' + str(index_iter + 1) + '.hdf5'
    ...
    with open('./Loss_Acc/UP_ResNeXt_TwoStepAttention_4_1_5_60_group10_1', 'w') as f:
...
modelStatsRecord.outputStats(KAPPA_3D_DenseNet, OA_3D_DenseNet, AA_3D_DenseNet, ELEMENT_ACC_3D_DenseNet,
                             ...
                             './records/UP_train_ResNeXt_TwoStepAttention_4_1_5_60_group10_1.txt',
                             './records/UP_train_element_ResNeXt_TwoStepAttention_4_1_5_60_group10_1.txt')
