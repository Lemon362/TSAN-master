from keras.layers import GlobalAveragePooling3D, GlobalMaxPooling3D, Reshape, Dense, multiply, Permute, Concatenate, \
    Conv3D, Add, Activation, Lambda
...
def channel_attention(input_feature, ratio=8):
    ...
    avg_pool = shared_layer_one(avg_pool)  # Dense1：1024-->128
    # assert avg_pool._keras_shape[1:] == (1, 1, channel // ratio)
    avg_pool = shared_layer_two(avg_pool)  # Dense2：128-->1024
    # assert avg_pool._keras_shape[1:] == (1, 1, channel)
