...
# from Attention_Block_2D import residual_block
# from Attention_Block_2D import attention_block
...
def AttentionResNetCifar10(shape=(32, 32, 3), n_channels=32, n_classes=10):
    ...
    # x = attention_block(x,
    #                     encoder_depth=1)  # 第三个Attention Module在论文中是不需要要skip_connections的，所以encoder_depth在此处应该为0,不过代码为了方便还是设为1
...
if __name__ == '__main__':
    ...
    model.summary()
    plot_model(model, show_shapes=True, to_file='./model_residual_attention.png')
